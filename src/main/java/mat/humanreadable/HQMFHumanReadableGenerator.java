...
import mat.humanreadable.qdm.MATCssUtil;
...
public class HQMFHumanReadableGenerator implements MatConstants {
	...
	public static String generateHTMLForMeasure(String measureId,
		...
		try {
			Document humanReadableHTMLDocument = HeaderHumanReadableGenerator
			...
			if (simpleXMLProcessor == null) {
				Document htmlDocument = createBaseHumanReadableDocument();
...
//				.toLowerCase());
	...
	private static Document createBaseHumanReadableDocument() {
