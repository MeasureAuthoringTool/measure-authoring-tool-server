...
import mat.dao.measure.impl.MeasureSetDAOImpl;
...
import mat.service.measure.MeasureCloningService;
...
public class MeasureCloningServiceImpl implements MeasureCloningService {
	...
	@Autowired private MeasureXMLDAOImpl measureXmlDAO;
	@Autowired private MeasureSetDAOImpl measureSetDAO;
	@Autowired private UserDAOImpl userDAO;
	@Autowired private CQLServiceImpl cqlService;
