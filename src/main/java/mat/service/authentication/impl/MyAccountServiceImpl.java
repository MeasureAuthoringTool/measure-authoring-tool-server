...
import mat.service.authentication.MyAccountService;
import mat.validation.MyAccountModelValidator;
...
public class MyAccountServiceImpl implements MyAccountService {
	...
	/** The Constant logger. */
	private static final Logger logger = LogManager.getLogger(MyAccountServiceImpl.class);
	...
	@Autowired SecurityQuestionsService securityQuestionsService;
