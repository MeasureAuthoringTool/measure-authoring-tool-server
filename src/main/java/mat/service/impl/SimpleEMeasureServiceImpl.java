...
import mat.service.code.impl.CodeListXLSGenerator;
import mat.util.StringUtility;
import mat.cql.CQLUtil;
import mat.filesystem.FileNameUtility;
import mat.measure.measuredetails.CompositeMeasureDetailUtil;
import mat.measure.measuredetails.models.ManageCompositeMeasureDetailModel;
import mat.result.SaveUpdateCQLResult;
import mat.hqmf.Generator;
import mat.hqmf.HQMFGeneratorFactory;
import mat.humanreadable.HumanReadableGenerator;
...
public class SimpleEMeasureServiceImpl implements SimpleEMeasureService {
	...
	private static final Logger LOGGER = LogManager.getLogger(SimpleEMeasureServiceImpl.class);
	 ...
	 * @return Measure. *
	 */
	private Measure getMeasureName(final String measureId) {
		MeasurePackageService measureService = (MeasurePackageService) context.getBean("measurePackageService");
		Measure measure = measureService.getById(measureId);
		return measure;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see mat.service.SimpleEMeasureService#getSimpleXML(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getEMeasureHTML(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getHumanReadableForNode(java.lang.
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getEMeasureXLS(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getValueSetXLS(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getEMeasureZIP(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * mat.service.SimpleEMeasureService#getBulkExportZIP(java.lang.String[])
	 */
	@Override
	...
	@Override
	public BonnieCalculatedResult getBonnieExportCalculation(String measureId, String userId) throws IOException, BonnieUnauthorizedException, BonnieNotFoundException, BonnieServerException, BonnieBadParameterException, BonnieDoesNotExistException, BonnieUnauthorizedException, BonnieServerException, BonnieNotFoundException, BonnieDoesNotExistException, BonnieBadParameterException {
