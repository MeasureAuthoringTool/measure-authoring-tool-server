...
public class ValueSetXLSGenerator extends XLSGenerator {
	...
	/* (non-Javadoc)
	 * @see mat.service.impl.XLSGenerator#cacheXLSRow(mat.entity.ListObject, mat.dao.ListObjectDAO, java.sql.Timestamp)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.service.impl.XLSGenerator#getErrorXLS()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.service.impl.XLSGenerator#cacheXLSRow(mat.model.valueset.MatValueSet)
	 */
	@Override
