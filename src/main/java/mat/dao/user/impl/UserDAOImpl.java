...
public class UserDAOImpl extends GenericDAO<User, String> implements UserDAO {
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#expireTemporaryPasswords(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#unlockUsers(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#searchForUsersByName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#searchAllUsedOrganizations()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#searchNonAdminUsers(java.lang.String, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#getAllNonAdminActiveUsers()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#getUser(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#userExists(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#findUniqueLoginId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#findByEmail(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#findByLoginId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#saveUserDetails(mat.entity.MatUserDetails)
	 */
	@Override
	...
	// US212
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#setUserSignInDate(java.lang.String)
	 */
	@Override
	...
	// US212
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#setUserSignOutDate(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#getRandomSecurityQuestion(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mat.dao.user.UserDAO#searchForNonTerminatedUser()
	 */
	@Override
