...
public class MeasureAuditLogDAOImpl extends GenericDAO<MeasureAuditLog, String> implements MeasureAuditLogDAO {
	...
	public boolean recordMeasureEvent(Measure measure, String event, String additionalInfo){
		...
		try {
			...
			measureAuditLog.setUserId(userDAO.find(LoggedInUserUtil.getLoggedInUser()).getEmailAddress());
