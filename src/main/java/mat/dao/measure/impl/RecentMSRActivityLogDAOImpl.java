...
public class RecentMSRActivityLogDAOImpl extends GenericDAO<RecentMSRActivityLog, String> implements RecentMSRActivityLogDAO {

	private static final Logger logger = LogManager.getLogger(RecentMSRActivityLogDAOImpl.class);
