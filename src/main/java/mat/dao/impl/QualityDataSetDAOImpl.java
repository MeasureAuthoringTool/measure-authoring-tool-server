...
public class QualityDataSetDAOImpl extends GenericDAO<QualityDataSet, String> implements mat.dao.QualityDataSetDAO {
	...
	private String getQDSQueryString(boolean showSDEs){
		String query = "select q.id from mat.entity.QualityDataSet q, mat.entity.ListObject l " +
	...
	/* (non-Javadoc)
	 * @see mat.dao.QualityDataSetDAO#cloneQDSElements(java.lang.String, mat.model.measure.Measure)
	 */
	@Override
