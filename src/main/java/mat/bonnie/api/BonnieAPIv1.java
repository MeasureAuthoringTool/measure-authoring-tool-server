...
import mat.api.connection.APIConnectionUtillity;
import mat.bonnie.result.BonnieOAuthResult;
import mat.filesystem.FileInfomationObject;
...
public class BonnieAPIv1 implements BonnieAPI {
	...
	private static final Logger logger = LogManager.getLogger(BonnieAPIv1.class);
