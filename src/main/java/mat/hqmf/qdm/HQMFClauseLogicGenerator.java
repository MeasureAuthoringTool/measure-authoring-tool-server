...
public class HQMFClauseLogicGenerator implements Generator {
	 ...
	 */
	private static final Map<String, String> FUNCTIONAL_OPS_NON_SUBSET = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	/**
	 * MAP of Functional Ops Subset Type.
	 */
	private static final Map<String, String> FUNCTIONAL_OPS_SUBSET = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	static {
	...
	private static final Map<String, List<String>> FUNCTIONAL_OP_RULES_IN_POP = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	
	/** The Constant FUNCTIONAL_OP_RULES_IN_MO. */
	private static final Map<String, List<String>> FUNCTIONAL_OP_RULES_IN_MO = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	...
	/* (non-Javadoc)
	 * @see mat.server.simplexml.hqmf.Generator#generate(mat.model.measure.MeasureExport)
	 */
	@Override
