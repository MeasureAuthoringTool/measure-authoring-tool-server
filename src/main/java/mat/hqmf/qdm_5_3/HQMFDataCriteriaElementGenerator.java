...
public class HQMFDataCriteriaElementGenerator implements Generator {
	...
	/** The Constant logger. */
	private static final Logger logger = LogManager.getLogger(HQMFDataCriteriaElementGenerator.class);
	...
	private String getDataCriteriaExtensionValue(MeasureExport me) {
	...
	private void createDataCriteriaForQDMELements(MeasureExport me, XmlProcessor dataCriteriaXMLProcessor,
			XmlProcessor simpleXmlprocessor) throws Exception {
		...
		try {
			...
			generateCQLQDMNodeEntries(dataCriteriaXMLProcessor, simpleXmlprocessor, qdmNoAttributeNodeList);
	...
	protected void getExtensionValueBasedOnVersion(MeasureExport me) {
		if (me != null) {
			extensionValue = getDataCriteriaExtensionValue(me);
		}
	}
	...
	private void generateCQLQDMNodeEntries(XmlProcessor dataCriteriaXMLProcessor, XmlProcessor simpleXmlprocessor,
